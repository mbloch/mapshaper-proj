...
function pj_healpix(P, rhealpix) {
   ...
   **/
  // static CapMap get_cap(double x, double y, int north_square, int south_square, int inverse) {
   ...
   **/
  // static XY combine_caps(double x, double y, int north_square, int south_square, int inverse) {
